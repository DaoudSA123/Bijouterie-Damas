  ...
  const services = [
    {
      ...
      description: "Transformez vos idées en bijoux sur mesure d'une beauté et d'une originalité incomparables. Avec un artisan joaillier d’exception à vos côtés, vos rêves prennent vie sous forme de pièces uniques, élégantes et finement travaillées. Faites votre demande dès aujourd'hui et découvrez nos autres créations personnalisées disponibles à l’achat.",
      image: "/hand.jpg"
    },
    {
      id: 1,
